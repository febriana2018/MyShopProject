                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        if(isset($_POST["daftar"]))
                        {
                            ...
                            $matched = $ambil->num_rows;

                            if($matched==1)
                            {
                                echo "<script>alert('Pendaftaran gagal, email sudah digunakan untuk mendaftar sebelumnya');</script>";
                            ...
                            else
                            {
                                ...
                                telepon,alamat_pelanggan)
                                VALUES ('$email','$password','$nama','$telp','$alamat') ");
